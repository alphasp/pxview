...
class Detail extends Component {
  ...
  onLayout = (event) => {
    ...
    this.setState({
      footerPosition: event.nativeEvent.layout.y
    })
  }
  handleOnScroll = (event) => {
    ...
    // });
    console.log(event.nativeEvent.contentOffset.y, footerPosition)
    if (event.nativeEvent.contentOffset.y >= footerPosition) {
      this.setState({
